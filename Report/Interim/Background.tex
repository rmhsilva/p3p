...
\subsection{HMMs \cite{rabiner1989tutorial}} % (fold)
...
The next step up in complexity from single word HMMs is models that consider sub-word utterances (phenomes).  talk about this...
