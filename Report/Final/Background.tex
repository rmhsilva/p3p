...
\label{sec:speech_recognition_systems}
	...
	\label{sub:tors_algorithm}
		...
		%TODO somewhere: why didn't I do this?
...
\label{sec:about_hmms}
	...
	\label{sub:levels_of_complexity}
		...
		%TODO: confirm 'senone' was started by Sphinx...
	...
	% subsection viterbi_decoding (end)
...
\label{sec:embedded_hardware}
	...
	% TODO
	% Both melnikoff and speech silicon deal with very large FPGAs and designs
	% My project is on a far smaller and constrained system, and isn't meant to be as rigorous - it's more an exploration of ASR and the boards...
	% These projects were very useful as guides for what's possible / important etc  --  WHY do I mention them?
