...
\label{sec:system_overview}
	...
	\begin{figure}[tb]
		\begin{center}
			\includegraphics[width=\figwidth]{high-level-system-overview.png}
		\end{center}
...
\label{sec:la_papessa_fpga}
	...
	\label{sub:top_level_module}
		...
		\begin{figure}[tb]
			\begin{center}
				\includegraphics[width=\figwidth]{DesignHeirarchy.PNG}
			\end{center}
...
\end{lstlisting}
	...
	\subsection{Normaling and Sending Scores} % (fold)
	...
	% TODO synthesis? Describe how the design didn't fit?
...
\label{sec:support_software}
	% TODO: write about Lisp utils etc
	% HMMdefs parser - extracts senone parameters
	% SysVerilog testbench creation
	% Software approximation of hardware
	% Utilities for converting to and from binary
